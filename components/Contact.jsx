  ...
  const handleFormSubmit = async (e) => {
    ...
    try {
      if (
        ...
        const req = await sendEmail(firstName, lastName, email, phone, message);
        if (req.status === 200) {
          setEmailRes({
            status: req.status,
        ...
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12">
            <div className="px-3 sm:px-0 mb-12 max-w-[570px] lg:mb-0">
              <span
                className={`text-emerald-900 text-primary mb-4 block text-base font-semibold`}
              >
                Contact Us
              </span>
              <h2
              ...
              <p
                className={`${hiraDarkBrownText} mb-9 text-base leading-relaxed`}
              >
